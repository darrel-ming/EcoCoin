...
QT_MOC_LITERAL(1, 12, 10), // "remoteCall"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7) // "message"

    },
    "DBusHandler\0remoteCall\0\0message"
};
...
void DBusHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->remoteCall((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->remoteCall((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
