...
void MainWindow::on_btn_WalletCreateAddress_clicked()
{
}
...
void MainWindow::listwalletcoins(QString ID)
{
    ...
    if (ui->encrypted_yes->text() == "Yes")
    {
        ...
        query.append("SELECT * FROM users WHERE name ="
                     "'" +
                     bFname + "'");
    }
    else
...
void MainWindow::EAN13(QString productname, QString country, QString ean, QGraphicsView *graphicsView)
{ //barcode not used
#ifdef BARCODE
